...
<header>
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-start flex-grow-1">
              ...
              <li class="nav-item dropdown">
                ...
                <form method="GET" action="especies_fauna.php" class="d-flex ms-3 align-items-center" style="max-width: 250px;">
  ...
  <main class="fixed-top-offset">
    <div class="container">
      <h4 class="text-center py-3" id="pageTitle">Listado de Especies de Fauna</h4>
      ...
      if ($searchTerm) {
        ...
        foreach ($filteredAvistamientos as $avistamiento): ?>
          <div style="width: 16rem;" class="card card-default border:9 p-3 mb-5">
