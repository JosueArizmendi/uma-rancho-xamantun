        ...
        <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasNavbar"
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-start flex-grow-1">
              ...
              <!-- Buscador de Avistamientos de Fauna -->
              <li class="nav-item dropdown">
                <!-- Este es el cambio en el formulario de búsqueda -->
                <form method="GET" action="avistamientos_fauna.php" class="d-flex ms-3 align-items-center" style="max-width: 250px;">
      ...
      if (filteredResults.length > 0) {
        ...
        filteredResults.forEach(result => {
          ...
          listItem.onclick = function() {
            // Limpiar la entrada de búsqueda para mostrar todos los resultados nuevamente
