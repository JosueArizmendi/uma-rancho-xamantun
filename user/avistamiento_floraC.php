    ...
    <header>
        <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
            ...
            <div class="container-fluid">
                <a class="navbar-brand fs-3 text-white" href="template2.php" id="navbar_title">Inicio</a>
                ...
                <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-start flex-grow-1">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-dark fs-3" href="#" role="button"
                                    data-bs-toggle="dropdown" id="fauna_link">Fauna</a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="especies_fauna.php" id="fauna_especies">Especies</a></li>
                                    <li><a class="dropdown-item" href="avistamientos_fauna.php" id="fauna_avistamientos">Avistamientos</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-dark fs-3 d-none d-md-block" href="#" role="button"
                                    data-bs-toggle="dropdown" id="flora_link">Flora</a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="especies_flora.php" id="flora_especies">Especies</a></li>
                                    <li><a class="dropdown-item" href="avistamientos_flora.php" id="flora_avistamientos">Avistamientos</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-dark fs-3 d-none d-md-block" href="#" role="button"
                                    data-bs-toggle="dropdown" id="opciones_link">Opciones</a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="avistamiento_faunaR.php" id="registro_fauna">Registros avistamientos Fauna</a></li>
                                    <li><a class="dropdown-item" href="avistamiento_floraR.php" id="registro_flora">Registros avistamientos Flora</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                ...
                <div class="d-flex justify-content-end">
                    <a href="../logout.php" class="btn btn-danger ms-2" id="cerrar_sesion">Cerrar sesión</a>
                </div>
            </div>
        </nav>
    </header>
    ...
    <main class="fixed-top-offset">
        <div class="container">
            ...
            <div class="card card-default border:3 shadow p-3 mb-5">
                <form action="../model2/alta_avistamiento_flora.php" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                    <div class="row row-cols-4">
                        <div class="mb-3">
                            <label class="form-label" for="input_especie" id="input_especie_label">Especie</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="input_fecha_avista" id="input_fecha_avista_label">Fecha del avistamiento</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="input_latitud" id="input_latitud_label">Latitud</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="input_longitud" id="input_longitud_label">Longitud</label>
                    ...
                    <div class="row row-cols-2">
                        <div class="mb-3">
                            <label class="form-label" for="input_descripcion" id="input_descripcion_label">Descripción</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="input_imagen" id="input_imagen_label">Imagen</label>
