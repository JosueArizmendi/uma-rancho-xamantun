...
<body>
        ...
        <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasNavbar"
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-start flex-grow-1">
              ...
              <!-- Buscador de Avistamientos de Flora -->
              <li class="nav-item dropdown">
                <!-- Este es el cambio en el formulario de búsqueda -->
                <form method="GET" action="avistamientos_flora.php" class="d-flex ms-3 align-items-center" style="max-width: 250px;">
      ...
      if (filteredResults.length > 0) {
        ...
        filteredResults.forEach(result => {
          ...
          listItem.onclick = function() {
            document.getElementById('searchInput').value = result.nombre_cientifico;
            resultsContainer.style.display = 'none'; // Ocultar resultados después de hacer clic
            // Redirige a la página con el avistamiento seleccionado
            window.location.href = 'avistamientos_flora.php?search=' + encodeURIComponent(result.nombre_cientifico);
          };
  ...
  <main class="fixed-top-offset">
    <div class="container">
      <h4 class="text-center py-3">Listado de Avistamientos de Flora</h4>
      <div class="row row-cols-5 grid gap-2">

        <?php
        // Filtrar los avistamientos de flora si hay un término de búsqueda
        ...
        foreach ($filteredAvistamientos as $avistamiento): ?>
          <div style="width: 16rem;" class="card card-default border:3 p-3 mb-5">
            <img src="<?= '../' . $avistamiento['ruta_imagen']; ?>" class="card-img-top" style="max-width: 220; height: 160px;">
            <div class="card-body">
              ...
              ?>
              <a href="avistamiento_flora_ficha.php?id_avistamiento=<?= $encoded_id ?>" class="btn btn-primary">Más información</a>
            </div>
          </div>
        <?php endforeach; ?>
      </div>
