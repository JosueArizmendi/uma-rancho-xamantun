...
<meta charset="UTF-8">
  ...
  <style>
    ...
    /* Para el espaciado superior de la página */
    .fixed-top-offset {
      padding-top: 35px; /* Ajustamos para que no se oculte el contenido debajo de la barra fija */
    }
    ...
    p {
      font-size: 1.1em; /* 1em es igual al tamaño de la fuente del elemento padre */
    }

    /* Contenedor con fondo blanco y bordes (ventanilla) */
    .ventanilla {
    ...
    .ventanilla-image img {
      max-width: 100%;
      height: auto;
      border-radius: 10px; /* Bordes redondeados para la imagen */
    }

    .ventanilla-description {
      margin-top: 20px;
    }

    /* Estilos para los textos dentro de la ventanilla */
    .ventanilla-description h3 {
      font-size: 1.5em;
      margin-top: 20px;
    }

    .ventanilla-description p {
      font-size: 1.1em; /* Fuente ligeramente más grande */
    }

    .ventanilla-description ul {
      list-style-type: none;
      padding-left: 0;
    }

    .ventanilla-description li {
      font-size: 1.1em;
      margin-bottom: 5px;
    }
...
<body>
  ...
  <div class="container"><!-- Ajustamos el padding-top para evitar que se oculte debajo de la cabecera fija -->
  ...
  <div class="container mt-1"><!-- Ajustamos el padding-top para evitar que se oculte debajo de la cabecera fija -->
  <div id="google_translate_element" style="text-align: right;"></div>
  </div>
  <br><br>
  <div class="container py-4">
    <!-- Ajustamos el padding-top para evitar que se oculte debajo de la cabecera fija -->
    <div class="content">
      <h2 class="mb-4 text-center">Acerca de UMA del Rancho Xamantún</h2>

      <!-- Contenedor con fondo blanco y borde (ventanilla) -->
      <div class="ventanilla">
        <!-- Imagen dentro del contenedor -->
        <div class="ventanilla-image">
          <img src="../img/foto.jfif" width="250px" height="250px">
          <img src="../img2/uma_xamantun.jpg" class="img-fluid mb-4" alt="Imagen de UMA del Rancho Xamantún">
        </div>

        <!-- Descripción dentro del contenedor -->
        <div class="ventanilla-description">
          <p>El proyecto "UMA del Rancho Xamantún" tiene como objetivo la conservación y estudio de la flora y fauna local. A través de la investigación y los avistamientos, buscamos generar conciencia sobre la importancia de preservar las especies autóctonas de la región.</p>

          <h3>Información de contacto</h3>
          <p><strong>Teléfono:</strong> (981) 827 20 81 </p>
          <p><strong>Institución:</strong> Instituto Tecnológico de Chiná</p>

          <h3>Alumnos Creadores:</h3>
          <ul>
            <li>* Alan Virgilio Castillo Gómez.</li>
            <li>* Josué Gabriel Arizmendi Trinidad.</li>
          </ul>

          <h3>Encargado del laboratorio de Modelos de Desarrollo Sostenible:</h3>
          <ul>
            <li>* Mtro. Héctor Octavio Guerrero Turriza.</li>
          </ul>
          <ul>
            <img src="../img2/hector_guerrero.jpg" class="img-fluid mb-4" width="90px" height="100px">
          </ul>
          <p>Este proyecto fue desarrollado por los alumnos del Instituto Tecnológico de Chiná, con el apoyo de la comunidad local.</p>
        </div>
      </div>
    </div>
  </div>
