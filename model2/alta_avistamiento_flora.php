    ...
    try {
        ...
        if (isset($_FILES['input_imagen']) && $_FILES['input_imagen']['error'] === UPLOAD_ERR_OK) {
            ...
            if (!in_array($fileType, $allowedFileTypes)) {
                ...
                header('Location: ../user/avistamiento_floraC.php');
                exit;
            }
        ...
        if ($stmt->execute()) {
            $_SESSION['notification'] = [
                'type' => 'success',
                'title' => '¡Éxito!',
                'message' => 'El avistamiento de flora se ha registrado correctamente.'
            ];
            header('Location: ../user/avistamiento_floraR.php');
            exit;
        } else {
