...
try {
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql = "SELECT * FROM especies_flora WHERE id_especie = :id";
    ...
    $redirect = $_SERVER['REQUEST_METHOD'] == 'POST' 
        ? '../admin/especie_floraR.php' 
        : '../admin/especie_floraU.php?id_especie=' . urlencode($_REQUEST['id_especie']);
