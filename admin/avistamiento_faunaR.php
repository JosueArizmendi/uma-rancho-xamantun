...
<body>
  ...
  <header>
    <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
      ...
      <div class="container-fluid">
        ...
        <!-- Agregar los botones de Cerrar sesión -->
  ...
  <main class="fixed-top-offset">
    <div class="container">
      <h4 class="text-center py-2">Listado de Avistamientos de Fauna</h4>

      <!-- Sección de Nuevo Registro y Buscadores -->
              ...
              <tbody>
                ...
                foreach ($filteredAvistamientos as $avistamiento): ?>
                  <tr>
                    ...
                    <td>
                      <?= $avistamiento['nombre_cientifico']; ?>
                    </td>
                    <td>
                    ...
                    <td>
                      <?= strlen($avistamiento['descripcion']) > 10 ? substr($avistamiento['descripcion'], 0, 10) . '...' : $avistamiento['descripcion']; ?>
                    </td>
                    <td>
                    ...
                    <td>
                      <a class="bi bi bi-pencil-square btn btn-primary shadow-sm"
                        href="avistamiento_faunaU.php?id_avistamiento=<?= base64_encode($avistamiento['id_avistamiento']) ?>"></a>
                    </td>
                    <td>
                      <a class="bi bi-trash3-fill btn btn-danger shadow-sm"
                        href="../model/borrar_avistamiento_fauna.php?id_avistamiento=<?= base64_encode($avistamiento['id_avistamiento']) ?>"></a>
                    </td>
                    <td>
                        <a class="btn btn-success shadow-sm" href="../model/generar_pdf_avistamiento.php?id_avistamiento=<?=  base64_encode($avistamiento['id_avistamiento']); ?>" onclick="mostrarBarraProgreso()">
