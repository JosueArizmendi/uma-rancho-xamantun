...
<body>
    ...
    <main class="fixed-top-offset">
        <div class="container">
            <h4 class="text-center py-2">Crear Nuevo Blog</h4>
            
            <?php if (isset($_GET['error'])): ?>
                <div class="alert alert-danger">
                    Error al crear el blog. Por favor, inténtalo de nuevo.
                </div>
            <?php endif; ?>

            <div class="card card-default border:3 shadow p-3 mb-5">
                <form action="../model/alta_blog.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    <div class="row row-cols-1">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="<?= htmlspecialchars($user_data['nom_usuario']) ?>" readonly>
                        </div>
