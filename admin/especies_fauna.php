...
// Incluir los archivos necesarios después de iniciar la sesión.
include '../model/leer_especies_fauna.php';
...
<header>
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-start flex-grow-1">
              ...
              <li class="nav-item dropdown">
                ...
                <form method="GET" action="especies_fauna.php" class="d-flex ms-1 align-items-center" style="max-width: 250px;">
                  <div class="input-group">
                    <input type="text" name="search" class="form-control form-control-sm-4" id="searchInput" placeholder="Buscar Especies" 
  ...
  <script>
    // Array con las especies (esto debe ser generado desde PHP)
    const species = [
        ...
        if (filteredResults.length > 0) {
          ...
          filteredResults.forEach(result => {
            ...
            listItem.onclick = function() {
              // Redirige a la página con la especie seleccionada
              window.location.href = 'especies_fauna.php?search=' + encodeURIComponent(result.nombre_cientifico);
            };
            resultsContainer.appendChild(listItem);
          });
        } else {
          resultsContainer.style.display = 'none'; // No resultados
        }
      } else {
  ...
  <main class="fixed-top-offset">
    <div class="container">
      <h4 class="text-center py-3">Listado de Especies de Fauna</h4>
        ...
        foreach ($filteredAvistamientos as $avistamiento): ?>
          <div style="width: 16rem;" class="card card-default border:3 p-3 mb-5">
            ...
            <div class="card-body">
              ...
              <a href="especie_fauna_ficha.php?id_especie=<?php echo codificar($avistamiento['id_especie']) ?>" class="btn btn-primary">Más información</a>
            </div>
          </div>
        <?php endforeach; ?>
      </div>
