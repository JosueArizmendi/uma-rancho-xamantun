...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['crear'])) {
    ...
    try {
        ...
        header("Location: comentarios_blogR.php?mensaje=Comentario creado exitosamente");
        exit;
...
<header>
            ...
            <ul class="navbar-nav justify-content-start flex-grow-1">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="app.php">Mapa Interactivo</a></li>                  <li><a class="dropdown-item" href="curriculum.php">Curriculum</a></li> 
  ...
  <main class="fixed-top-offset">
    <div class="container">
        <h4 class="text-center py-2">Crear Nuevo Comentario</h4>
                ...
                <form method="POST">
                    ...
                    <div class="d-flex justify-content-between">
                        <button type="submit" name="crear" class="btn btn-success">
                            <i class="bi bi-save"></i> Guardar Comentario
                        </button>
