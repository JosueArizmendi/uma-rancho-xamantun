...
<body>
  ...
  <main class="fixed-top-offset">
    <div class="container">
      <h4 class="text-center py-2">Listado de Especies de Flora</h4>
      ...
      <div class="card card-default border:3 shadow p-3 mb-5">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <div class="form-group">
            <a class="btn btn-success shadow-sm" href="especie_floraC.php?categoria=<?= $categoria ?>">Nuevo registro</a>
          </div>

          <!-- Formulario de búsqueda -->
          <!-- Formulario de búsqueda con lista desplegable -->
          <form method="GET" action="" class="d-flex w-auto">
            <select name="search" class="form-control form-control-sm custom-select" style="height: 30px;" onchange="this.form.submit()" style="height: 30px;">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                foreach ($filteredEspecies as $especie): ?>
                  <tr>
                    <td hidden>
                      <?php echo codificar( $especie['id_especie']); ?>
                    </td>
                    <td>
                    ...
                    <td>
                      <?= strlen($especie['descripcion_fisica']) > 10 ? substr($especie['descripcion_fisica'], 0, 10) . '...' : $especie['descripcion_fisica']; ?>
                    </td>
                    <td>
                      <?= strlen($especie['habitat']) > 10 ? substr($especie['habitat'], 0, 10) . '...' : $especie['habitat']; ?>
                    </td>
                    ...
                    <td>
                      ...
                      href="especie_floraU.php?id_especie=<?php echo codificar($especie['id_especie']) ?>&categoria=<?= $categoria ?>"></a>
                    </td>
                    <td>
                      <a class="bi bi-trash3-fill btn btn-danger shadow-sm"
                        href="../model/borrar_especie_flora.php?id_especie=<?php echo codificar($especie['id_especie']) ?>"></a>
                    </td>
                    <td>
                        <a class="btn btn-success shadow-sm" href="../model/generar_pdf2.php?id_especie=<?php echo codificar($especie['id_especie']); ?>" onclick="mostrarBarraProgreso()">
