...
<body>
  ...
  <main class="fixed-top-offset">
    <div class="container">
      <h4 class="text-center py-2">Listado de Avistamientos de Flora</h4>
                  ...
                  <tr>
                    ...
                    <td>
                      <a class="bi bi bi-pencil-square btn btn-primary shadow-sm"
                        href="avistamiento_floraU.php?id_avistamiento=<?= base64_encode($avistamiento['id_avistamiento']) ?>"></a>
                    </td>
                    <td>
                      <a class="bi bi-trash3-fill btn btn-danger shadow-sm"
                        href="../model/borrar_avistamiento_flora.php?id_avistamiento=<?= base64_encode($avistamiento['id_avistamiento']) ?>"></a>
                    </td>
                    <td>
