...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
            ...
            <div class="container-fluid">
                ...
                <!-- Aquí agregamos los botones en el header -->
  ...
  <script type="text/javascript" src="https://translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
    ...
    <main class="fixed-top-offset">
                    ...
                    <div class="row row-cols-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="input_clase" name="input_clase" required>
                                ...
                                <option value="Mammalia">Mammalia (Mamíferos)</option>
                                <option value="Aves">Aves</option>
                                <option value="Reptilia">Reptilia (Reptiles)</option>
                                <option value="Amphibia">Amphibia (Anfibios)</option>
                                <option value="Pisces">Pisces (Peces)</option>
                                <option value="Insecta">Insecta (Insectos)</option>
                                <option value="Arachnida">Arachnida (Arácnidos)</option>
                            </select>
                            <div class="valid-feedback">Campo correcto!</div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="input_orden" name="input_orden" required>
                                ...
                                <option value="Hyracoidea">Hyracoidea</option>
                                <option value="Insectivora">Insectivora</option>
                                <option value="Sirenia">Sirenia</option>
                                <option value="Pinnipedia">Pinnipedia</option>
                                <option value="Marsupialia">Marsupialia</option>
                                <option value="Cingulata">Cingulata</option>
                                <option value="Monotremata">Monotremata</option>
                                <option value="Pholidota">Pholidota</option>
                                <option value="Chrysochloridae">Chrysochloridae</option>
                                <option value="Dermoptera">Dermoptera</option>
                                <option value="Squamata">Squamata</option>
                                <option value="Psittaciformes">Psittaciformes</option>
                                <option value="Didelphimorphia">Didelphimorphia</option>
        ...
        <script src="../JS/bootstrap_validZZZZZZation.js"></script>
    </main>
    <br>
