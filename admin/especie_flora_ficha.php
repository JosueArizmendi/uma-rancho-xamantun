...
<body>
  ...
  <main class="fixed-top-offset">
    <div class="container">
      <h4 class="text-center py-3">Ficha de Especie</h4>
      <div class="col">
      ...
      <div class="card card-default border:3 shadow p-3 mb-5">
        <div class="row">
          <div class="col">
            ...
            <h4 class="fs-5 text"><strong>Fotografía:</strong></h4>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', async function () {
      ...
      const prompt = `Dame las características de esta especie de flora:
