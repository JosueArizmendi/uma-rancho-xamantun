                    ...
                    <div class="row row-cols-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="input_filo" name="input_filo" required>
                                ...
                                <option value="Magnoliophyta" <?= $especies['filo'] == 'Magnoliophyta' ? 'selected' : '' ?>>Magnoliophyta</option>
                                <option value="Pinophyta" <?= $especies['filo'] == 'Pinophyta' ? 'selected' : '' ?>>Pinophyta</option>
                                <option value="Pteridophyta" <?= $especies['filo'] == 'Pteridophyta' ? 'selected' : '' ?>>Pteridophyta</option>
                                <option value="Fanerógama" <?= $especies['filo'] == 'Fanerógama' ? 'selected' : '' ?>>Fanerógama</option>
                                <option value="Angiosperms" <?= $especies['filo'] == 'Angiosperms' ? 'selected' : '' ?>>Angiosperms</option>
                                <option value="Tracheophyta" <?= $especies['filo'] == 'Tracheophyta' ? 'selected' : '' ?>>Tracheophyta</option>
                            </select>
                            <div class="valid-feedback">Campo correcto!</div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="input_clase" name="input_clase" required>
                                ...
                                <option value="Magnoliopsida" <?= $especies['clase'] == 'Magnoliopsida' ? 'selected' : '' ?>>Magnoliopsida (dicotiledóneas)</option>
                                <option value="Liliopsida" <?= $especies['clase'] == 'Liliopsida' ? 'selected' : '' ?>>Liliopsida (monocotiledóneas)</option>
                                <option value="Pteridopsida" <?= $especies['clase'] == 'Pteridopsida' ? 'selected' : '' ?>>Pteridopsida (helechos)</option>
                                <option value="Eudicots" <?= $especies['clase'] == 'Eudicots' ? 'selected' : '' ?>>Eudicots</option>
                            </select>
                            <div class="valid-feedback">Campo correcto!</div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="input_orden" name="input_orden" required>
                                ...
                                <option value="Rosales" <?= $especies['orden'] == 'Rosales' ? 'selected' : '' ?>>Rosales</option>
                                <option value="Solanales" <?= $especies['orden'] == 'Solanales' ? 'selected' : '' ?>>Solanales</option>
                                <option value="Poales" <?= $especies['orden'] == 'Poales' ? 'selected' : '' ?>>Poales</option>
                                <option value="Brassicales" <?= $especies['orden'] == 'Brassicales' ? 'selected' : '' ?>>Brassicales</option>
                                <option value="Sapindales" <?= $especies['orden'] == 'Sapindales' ? 'selected' : '' ?>>Sapindales</option>
                                <option value="Malpighiales" <?= $especies['orden'] == 'Malpighiales' ? 'selected' : '' ?>>Malpighiales</option>
                                <option value="Fabales" <?= $especies['orden'] == 'Fabales' ? 'selected' : '' ?>>Fabales</option>
                                <option value="Malvales" <?= $especies['orden'] == 'Malvales' ? 'selected' : '' ?>>Malvales</option>
                                <option value="Ericales" <?= $especies['orden'] == 'Ericales' ? 'selected' : '' ?>>Ericales</option>
                                <option value="Arecales" <?= $especies['orden'] == 'Arecales' ? 'selected' : '' ?>>Arecales</option>
                            </select>
                            <div class="valid-feedback">Campo correcto!</div>
    ...
    <footer class="bg-danger text-white text-center py-3 fixed-bottom">
        <div class="container-fluid">
            <h4 class="d-flex justify-content-center align-items-center">
                &copy; 2025 - UMA del Rancho Xamantún. Todos los derechos reservados.
