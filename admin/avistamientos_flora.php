          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-start flex-grow-1">
              ...
              <li class="nav-item dropdown">
                ...
                <form method="GET" action="avistamientos_flora.php" class="d-flex ms-1 align-items-center" style="max-width: 250px;">
    ...
    <?php foreach ($avistamientos as $avistamiento): ?>,
      {
        ...
        "id_avistamiento": "<?= base64_encode( $avistamiento['id_avistamiento']); ?>"
      ...
      <div class="row row-cols-5 grid gap-2">
        ...
        foreach ($filteredAvistamientos as $avistamiento): ?>
          <div style="width: 16rem;" class="card card-default border:3 p-3 mb-5">
            ...
            <div class="card-body">
              <h5 class="card-title"><i><strong><?= $avistamiento['nombre_cientifico']; ?></i></strong></h5>
